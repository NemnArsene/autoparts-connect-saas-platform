...
export const HomeIcon = ({ color = '#888', size = 24 }: IconProps) => (
...
export const HomeFillIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M3 9.5L12 3L21 9.5V20C21 20.5523 20.5523 21 20 21H15V15H9V21H4C3.44772 21 3 20.5523 3 20V9.5Z"
      fill={color}
...
export const SearchIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const SearchFillIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="10.5" cy="10.5" r="7.5" fill={color} />
    <Path d="M16.5 16.5L21 21" stroke={color} strokeWidth={2.5} strokeLinecap="round" />
  </Svg>
);

export const BoxIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
    ...
    <Path d="M4 7L12 11L20 7" stroke={color} strokeWidth={2} />
  </Svg>
);

export const BoxFillIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M12 3L4 7V17L12 21L20 17V7L12 3Z"
      fill={color}
    />
    <Path d="M12 3V21M4 7L12 11L20 7" stroke="white" strokeWidth={1.5} />
  </Svg>
);

export const BellIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
    ...
    />
    <Path
      d="M13.73 21C13.5542 21.3031 13.3018 21.5547 12.9982 21.7295C12.6946 21.9043 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9043 11.0018 21.7295C10.6982 21.5547 10.4458 21.3031 10.27 21"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const BellFillIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M18 8C18 6.4087 17.3679 4.88258 16.2426 3.75736C15.1174 2.63214 13.5913 2 12 2C10.4087 2 8.88258 2.63214 7.75736 3.75736C6.63214 4.88258 6 6.4087 6 8C6 15 3 17 3 17H21C21 17 18 15 18 8Z"
      fill={color}
...
export const GridIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const GridFillIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const UserIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const CarIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M5 11L7 5H17L19 11"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <Rect x="2" y="11" width="20" height="7" rx="2" stroke={color} strokeWidth={2} />
    <Circle cx="7" cy="18" r="2" stroke={color} strokeWidth={2} />
    <Circle cx="17" cy="18" r="2" stroke={color} strokeWidth={2} />
  </Svg>
);

export const HeartIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M20.84 4.61C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.5783 8.50915 2.99817 7.05 2.99817C5.59085 2.99817 4.1917 3.5783 3.16 4.61C2.1283 5.6417 1.54817 7.04085 1.54817 8.5C1.54817 9.95915 2.1283 11.3583 3.16 12.39L12 21.23L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6053C22.3095 9.93789 22.4518 9.22248 22.4518 8.5C22.4518 7.77752 22.3095 7.06211 22.0329 6.39467C21.7563 5.72723 21.351 5.1208 20.84 4.61Z"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const HistoryIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const SettingsIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const SupportIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const LogoutIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const ChevronRightIcon = ({ color = '#888', size = 20 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M9 18L15 12L9 6" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

export const CloseIcon = ({ color = '#888', size = 24 }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
